...
export default function AssetWorkspace({ 
  ...
  const handlePublishWordPress = async (asDraft: boolean) => {
    ...
    if (currentApprovalStatus !== 'approved' && currentApprovalStatus !== 'published' && !asDraft) {
      triggerToast?.('Move asset to Approved before publishing live.', 'info');
      return;
    }
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-800 shadow-lg overflow-hidden min-w-0">
            ...
            <div className="bg-slate-900 border-b border-slate-800 p-4 md:px-6 flex flex-wrap justify-between items-start sm:items-center gap-3 bg-slate-900/95 sticky top-0 z-10">
              <div className="min-w-0 flex-1">
                <span className="text-[10px] font-mono text-slate-450 block mb-0.5">
                  ACTIVE DELIVERABLE
                </span>
              ...
              <div className="flex items-center flex-wrap gap-2 select-none">
                ...
                <button
                  ...
                  className={`flex items-center gap-1 px-3 py-1.5 border rounded text-xs font-semibold cursor-pointer ${
                    showApprovalPanel
                ...
                >
                  ...
                  <span className="capitalize">{currentApprovalStatus.replace('_', ' ')}</span>
                </button>
            ...
            {showApprovalPanel && onUpdateApproval && (
              <div className="px-4 py-3 bg-slate-950 border-b border-slate-850 space-y-3">
                  ...
                  <div className="flex flex-col xl:flex-row gap-5 items-start w-full animate-fade-in">
                    ...
                    <div className="flex-1 w-full space-y-2">
                      ...
                      <textarea
                        ...
                        className="w-full h-[380px] bg-slate-950 border border-slate-800 rounded-xl p-4 text-slate-200 placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-amber-500/40 text-xs md:text-sm font-mono leading-relaxed"
                      />
...
Include personalized subject line options, preview text, and direct booking links.`
        ...
        {/* Right Side: Refine chat & version history — full width below content until xl */}
        <div className="xl:col-span-4 space-y-6 min-w-0 w-full">
          ...
          {/* Version History          {/* Version History Panel allowing users to review and revert draft refinements */}
